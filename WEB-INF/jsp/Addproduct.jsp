                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="active treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li class="active"><a href="addProduct.html"><i class="fa fa-circle-o"></i> Add Product</a></li>
                ...
                <div class="wrapper">
                    ...
                    <div class="content-wrapper">
                        <div class="box box-default"> 
                            ...
                            %>  
                            <!-- Product Added Message End -->
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">  
                                    <form name ="form" action="addProduct.html" method="POST">
                                        <div class="form-group">
                                            <label>Product Type</label>
                                            <select class="form-control select2" name="producttype" style="width: 100%;">
                                                <option selected="selected">Web Application</option>
                                                <option>Mobile Application</option>
                                                <option>Desktop Application</option>
                                                <option>Other</option>
                                            </select>
                                            <label for="ProductName">Product Name</label>
                                            <input type="text" class="form-control" name="productname" id="exampleInputEmail1" placeholder="Enter Product" required>
