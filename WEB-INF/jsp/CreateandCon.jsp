...
color: red;
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="DP160401143215" disabled>
                                          ...
                                          &nbsp;<span id="errmsg"></span>
                                            ...
                                            <input type="text" id="quantity1" class="form-control"  placeholder="Enter Unit Price">
    ...
    //numeric value accept for Quantity
...
//numeric value accept for Unit Price
    $(document).ready(function () {
  //called when key is pressed in textbox
