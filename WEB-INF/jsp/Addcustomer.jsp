                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class=" active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="addCustomer.html"><i class="fa fa-circle-o"></i> Add Customer</a></li>
                ...
                <div class="content-wrapper">
                    <div class="box box-default">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form name ="form" action="addCustomer.html" method="POST">
                                        <div class="form-group">
                                            <label>Customer Name</label>
                                            <input type="text" class="form-control" name ="customername" id="exampleInputEmail1" placeholder="Enter Name">
